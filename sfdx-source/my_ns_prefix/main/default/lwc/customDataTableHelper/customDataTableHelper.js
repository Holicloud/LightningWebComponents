 ...
 * @return promise
 */
let buildQuery = async (limitOfRecords, objectApiName, offSetNumber, preValue, queryFields, searchByApiName, searchKey, whereClause, displayRecentlyViewed, additionalSearchByFields) => {
    let theWhereClause = '';
